...
import edu.ctct.ctctelearning.model.Role;
import edu.ctct.ctctelearning.model.User;
import edu.ctct.ctctelearning.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public User save(UserRegistrationDto registration) {
        ...
        user.setEmail(registration.getEmail() + "@" + registration.getEmailDomain());
